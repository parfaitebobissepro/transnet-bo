...
function amChartLineHome() {
	...
	dateAxis.renderer.labels.template.fill = am4core.color("#bdb5b5");

	var valueAxis = chart.yAxes.push(new am4charts.ValueAxis());
	valueAxis.logarithmic = true;
	valueAxis.renderer.minGridDistance = 20;
	valueAxis.renderer.labels.template.fill = am4core.color("#bdb5b5");
...
function amChartCylinder() {
	...
	categoryAxis.renderer.labels.template.fill = am4core.color("#bdb5b5");
